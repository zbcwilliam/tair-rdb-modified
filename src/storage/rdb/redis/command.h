...
#define RENAME_COMMAND 66
    {"rename",renameCommand,3,0},
#define RENAMENX_COMMAND 67
    {"renamenx",renamenxCommand,3,0},
#define FILTER_COMMAND 68
    {"filter", filterCommand,3,0}
};
