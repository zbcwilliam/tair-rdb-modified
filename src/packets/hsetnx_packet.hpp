 ...
 *
 */
#ifndef TAIR_PACKET_HSETNX_PACKET_H
#define TAIR_PACKET_HSETNX_PACKET_H
#include "base_packet.hpp"
namespace tair
{
  class request_hsetnx:public base_packet
  {
  public:
    request_hsetnx ()
    {
      setPCode (TAIR_REQ_HSETNX_PACKET);
      server_flag = 0;
      area = 0;
      version = 0;
      expire = 0;
    ...
    request_hsetnx (request_hsetnx & packet)
    {
  ...
  class response_hsetnx:public base_packet
  {
  public:
    ...
    {
      config_version = 0;
      setPCode (TAIR_RESP_HSETNX_PACKET);
      code = 0;
    }
  ...
  private:
    int32_t code;
    response_hsetnx (const response_hsetnx &);
  };
}
#endif
