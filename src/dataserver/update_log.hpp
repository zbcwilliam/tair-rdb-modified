 ...
 *
 * Version: $Id: update_log.hpp 302 2011-10-09 06:34:35Z choutian.xmm@taobao.com $
 *
 * Authors:
...
#define INVALID_LSN             ((uint64_t)(-1))
   ...
   public:
      ...
      void log(sn_operation_type operation_type, data_entry &key, std::vector<data_entry* > &value, uint16_t db_id);
